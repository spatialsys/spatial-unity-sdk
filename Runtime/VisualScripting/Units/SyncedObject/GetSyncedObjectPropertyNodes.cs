...
namespace SpatialSys.UnitySDK.VisualScripting
{
    ...
    public class GetSyncedObjectByIDNode : Unit
    {
        ...
        protected override void Definition()
        {
            ...
            syncedObject = ValueOutput<SpatialSyncedObject>(nameof(syncedObject), (f) => SpatialBridge.spatialComponentService.GetSyncedObjectByID(f.GetValue<int>(objectID)));
        }
    }
    ...
    public class GetSyncedObjectIsSyncedNode : Unit
    {
        ...
        protected override void Definition()
        {
            ...
            isSynced = ValueOutput<bool>(nameof(isSynced), (f) => SpatialBridge.spatialComponentService.GetSyncedObjectIsSynced(f.GetValue<SpatialSyncedObject>(syncedObject)));
        }
    }
    ...
    public class GetSyncedObjectIDNode : Unit
    {
        ...
        protected override void Definition()
        {
            ...
            objectID = ValueOutput<int>(nameof(objectID), (f) => SpatialBridge.spatialComponentService.GetSyncedObjectID(f.GetValue<SpatialSyncedObject>(syncedObject)));
        }
    }
    ...
    public class GetSyncedObjectOwnerNode : Unit
    {
        ...
        protected override void Definition()
        {
            ...
            owner = ValueOutput<int>(nameof(owner), (f) => SpatialBridge.spatialComponentService.GetSyncedObjectOwner(f.GetValue<SpatialSyncedObject>(syncedObject)));
        }
    }
    ...
    public class GetSyncedObjectHasControlNode : Unit
    {
        ...
        protected override void Definition()
        {
            ...
            hasControl = ValueOutput<bool>(nameof(hasControl), (f) => SpatialBridge.spatialComponentService.GetSyncedObjectHasControl(f.GetValue<SpatialSyncedObject>(syncedObject)));
        }
    }
}
