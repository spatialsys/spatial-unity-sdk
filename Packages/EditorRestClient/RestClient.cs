...
namespace Proyecto26
{
    ...
    public static partial class RestClient
    {
        ...
        {
            EditorCoroutineUtility.StartCoroutineOwnerless(HttpBase.DefaultUnityWebRequest(options, callback));
        }
        ...
        {
            EditorCoroutineUtility.StartCoroutineOwnerless(HttpBase.DefaultUnityWebRequest<T>(options, callback));
        }
